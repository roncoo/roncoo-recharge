 ...
 */
package com.roncoo.recharge.api.longguo;
 ...
 * 充值模拟接口
 */
@Service("longguochongzhi")
public class LongguoRechargeFacadeImpl extends BaseRoncoo implements RechargeFacade, BalanceFacade {
		...
		try {
			notifyExecutor.execute(new Runnable() {
				...
				public void run() {
					...
					map.put("sign", SignUtil.getSign(map, "5b86fc6a47b64932a0dc22af43b904c9"));
